(function(){
  'use strict';
  homeAppService.factory('Auth', ['$firebaseAuth', 'FURL', '$firebaseObject', '$firebaseArray', '$state', '$http', 'DatabaseConfig', function($firebaseAuth, FURL, $firebaseObject, $firebaseArray, $state, $http, DatabaseConfig){
    var _instance = this;
